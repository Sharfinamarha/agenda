            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="start" id="start_time" data-toggle="datetimepicker" class="form-control datetimepicker datetimepicker-input" required>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="end" id="finish_time" data-toggle="datetimepicker" class="form-control datetimepicker datetimepicker-input" required>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-calendar-plus-fill"></i></span>
                        <input type="text" name="start" id="edit-start_time" data-toggle="datetimepicker" class="form-control datetimepicker datetimepicker-input" required>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="end" class="form-label">Tanggal Selesai Agenda</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-calendar-minus-fill"></i></span>
                        <input type="text" name="end" id="edit-finish_time" data-toggle="datetimepicker" class="form-control datetimepicker datetimepicker-input" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
